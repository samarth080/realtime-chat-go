...
import { Zap, Copy, LogOut, MessageSquarePlus, X, ArrowLeft } from 'lucide-react'
...
export function ChatPage() {
  ...
  return (
    <div style={{
      ...
      {/* Top bar — hidden on mobile when chat is open (ChatWindow has its own header) */}
      ...
      <div style={{ flex: 1, display: 'flex', overflow: 'hidden' }}>
        ...
        {showSidebar && (
          <div style={{
            ...
            borderRight: isMobile ? 'none' : '1px solid rgba(99,102,241,0.12)',
          }}>
            {/* New chat button */}
                ...
                <div className="animate-slide-up" style={{ marginTop: 8, display: 'flex', gap: 6 }}>
                  <input
                    ...
                    style={{
                      ...
                      borderRadius: 8, color: '#ededef', fontSize: 13,
                      fontFamily: "'JetBrains Mono', monospace",
                      padding: '10px 12px', outline: 'none',
                      // Larger on mobile for easier typing
                  ...
                  <button
                    ...
                    style={{
                      width: isMobile ? 48 : 34, height: isMobile ? 48 : 34,
